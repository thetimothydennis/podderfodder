...
export function ForgotPassword() {
	...
	return (
		<div className="Epi">
			...
			<p>
				To start the password recovery process, provide the email
				address you used during sign-up.
			</p>
			<form
				className="container"
				method="POST"
			...
			<p>
				After clicking submit, check your email for a link to reset your
				password.
			</p>
		</div>
	);
...
export function ResetPassword() {
	...
	return (
		<div className="Epi">
			...
			<p>
				If the provided passwords don&apos;t match, you will be
